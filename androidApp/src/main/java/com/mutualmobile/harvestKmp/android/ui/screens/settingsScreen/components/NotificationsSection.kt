...
//    )
    SettingsListItem(
        title = stringResource(MR.strings.notifications_section_alert_price_title.resourceId),
        subtitle = stringResource(MR.strings.notifications_section_alert_price_subtitle.resourceId),
        isCheckable = true,
    )
}